...
# Chosen because each one has the four properties a save-worthy quote needs:
#   1. Specific concrete detail (object, place, time, action)
...
QUALITY BAR — these are the kind of lines that get screenshotted and
sent in DMs. Your candidates should match this density of specificity
and surprise. Do not copy them; match their sharpness.
  ...
  - "The five minutes I sit in the car before going inside is the only
    therapy I can afford."

Common thread: specific noun, specific scene, unexpected pivot. If your
candidate is missing a concrete noun (car, knock, bathroom, group chat,
therapist, mom, morning) it is probably too abstract.
"""


# Enforced on every mode. Curated list of things that sound deep but mean
# nothing — the model reaches for these when it can't find a real insight.
_BANNED_STRUCTURES = """\
