...
# IST = UTC + 5:30:
#   06:00 IST = 00:30 UTC  →  utc_hour=0
#   11:00 IST = 05:30 UTC  →  utc_hour=5
#   14:00 IST = 08:30 UTC  →  utc_hour=8
#   17:00 IST = 11:30 UTC  →  utc_hour=11
#   21:00 IST = 15:30 UTC  →  utc_hour=15
#   01:00 IST = 19:30 UTC  →  utc_hour=19
...
# ---------------------------------------------------------------------------
# Emergency fallback quotes — used only when Gemini + curated pool both fail.
# ---------------------------------------------------------------------------
FALLBACK_QUOTES = {
    "morning": [
